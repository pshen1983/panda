...
include_once ("language/l_b_work_created_by_me.inc.php");
...
if( isset($_SESSION['_project']) && !empty($_SESSION['_project']) ) 
{
	...
	$wps = SearchDBUtil::getWorkPackageCreatedByMe($_SESSION['_userId'], $_SESSION['_project']->id);
	...
	$wis = SearchDBUtil::getWorkItemCreatedByMe($_SESSION['_userId'], $_SESSION['_project']->id);
