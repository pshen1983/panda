...
include_once ("language/l_b_work_closed_by_me.inc.php");
...
if( isset($_SESSION['_project']) && !empty($_SESSION['_project']) ) 
{
	...
	$wps = SearchDBUtil::getWorkPackageClosedByMe($_SESSION['_userId'], $_SESSION['_project']->id);
	...
	$wis = SearchDBUtil::getWorkItemClosedByMe($_SESSION['_userId'], $_SESSION['_project']->id);
