...
include_once ("language/l_b_work_owned_by_me.inc.php");
...
if( isset($_SESSION['_project']) && !empty($_SESSION['_project']) ) 
{
	...
	$wps = SearchDBUtil::getWorkPackageOwnedByMe($_SESSION['_userId'], $_SESSION['_project']->id);
	...
	$wis = SearchDBUtil::getWorkItemOwnedByMe($_SESSION['_userId'], $_SESSION['_project']->id);
